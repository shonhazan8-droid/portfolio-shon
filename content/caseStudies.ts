...
export const caseStudies: CaseStudy[] = [
  {
    ...
    summary: "The site was organized around departments. We rebuilt it around the real situations that bring people in.",
  ...
  },
  {
    ...
    summary: "Digitizing the flow removed the banker who built confidence. The redesign asks for one decision at a time.",
